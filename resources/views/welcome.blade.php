...
<x-custom>
    <x-slot name="content">
        <div class="hidden lg:block absolute -right-10 top-44" style="z-index: -1"><img width=900px
                                                                                        src="{{asset('img/vector-welcome.png')}}">
        </div>
        <div class="hidden md:block lg:hidden absolute -right-10 top-44" style="z-index: -1"><img width=450px
                                                                                                  src="{{asset('img/vector-welcome.png')}}">
        </div>
        <div class="container mt-2 lg:mt-14 py-2 md:py-10 lg:px-32 mx-auto gap-10">
            <div class="flex flex-wrap -mx-3 overflow-hidden mb-14 lg:mb-72">
                ...
                <div
                    class="my-3 px-3 w-full overflow-hidden font-black md:hidden block text-3xl md:text-4xl text-center">
                    Helping Others is The Way We Help Ourself
                </div>

                <div class="my-3 px-3 w-full hidden md:block overflow-hidden md:w-1/2">
                    Donasi mulai dari hal-hal kecil dan sederhana. Bantu mereka yang sedang membutuhkan. Bantu tuntaskan
                    kasus stunting dan kelaparan di
                ...
                <div class="my-3 px-3 w-full overflow-hidden text-center md:text-left">
                    <a href="{{route('register')}}">
                        <x-jet-button class="text-base rounded-full">Daftar Sekarang</x-jet-button>
                    </a>
                </div>
            </div>
            <div class="bg-white mb-16 text-black text-3xl text-center rounded-full py-2 max-w-2xl m-auto">Kemana Anda
                Bisa Menyumbang Dana?
            </div>
                            ...
                            <div class="flex-1">
                                <div class="flex items-center space-x-3">
                                    <img class="w-10 h-10 bg-gray-300 rounded-full flex-shrink-0"
                                         src="{{asset('img/thumbnail')."/".$datacategory->photo.".png"}}" alt="">
                                    <h3 class="text-gray-900 text-2xl font-bold truncate">{{ $datacategory->name }}</h3>

                                </div>
                                <p class="mt-5 text-gray-500 text-xl break-words">{{ $datacategory->description}}
                                    <br><br></p>
                            </div>
      ...
      "
          ...
          "
            ...
            <div class="grid grid-cols-3 w-full gap-5 mb-32">
                ...
                <div
                    class="bg-white  mx-auto text-center rounded-lg shadow-lg max-w-xs col-span-3 md:col-span-1 text-center">
                    <img
                        src="https://akcdn.detik.net.id/community/media/visual/2021/07/12/ibu-menyusui-1_169.jpeg?w=700&q=90"
                        alt="" class="rounded-t-3xl">
                    <div class="p-6 -mt-5 relative bg-white rounded-t-3xl">
                        <h2 class="font-bold mb-2 text-lg text-gray-900">Apakah Ibu Menyusui Boleh Vaksin? Catat
                            Ketentuannya di Sini!
                        </h2>
                        <p class="text-gray-700 mb-2">Program vaksinasi di Indonesia masih terus berjalan. Pelaksanaan
                ...
                <div
                    ...
                    <div class="p-6 -mt-5 relative bg-white rounded-t-3xl text-center">
                        <h2 class="font-bold mb-2 text-lg text-gray-900 text-center">Susu Berwarna Putih ini Kata Pakar
                            IPB
                        </h2>
                        <p class="text-gray-700 text-center mb-2">Pernah terpikirkan mengapa susu berwarna putih? Bukan
                ...
                <div class="bg-white  mx-auto text-center rounded-lg shadow-lg max-w-xs col-span-3 md:col-span-1">
                    <img src="https://lifepack.id/wp-content/uploads/2020/10/peran-dokter-pandemi-1-768x512.jpg" alt=""
                         class="rounded-t-3xl">
                    <div class="p-6 -mt-5 relative bg-white rounded-t-3xl text-center">
                        <h2 class="font-bold mb-2 text-lg text-gray-900 text-center">Peran Penting Dokter dan Layanan
                            Telemedik Saat Pandemi
                        </h2>
                        <p class="text-gray-700 text-center mb-2">Pemanfaatan layanan kesehatan digital berwujud
            ...
            <div class="grid grid-cols-6 items-center gap-1">
                <div class="text-2xl col-span-6 md:col-span-4 md:text-3xl text-center font-normal">Berminat ikuti kami
                    untuk membantu warga yang membutuhkan?
                </div>
                <div class="col-span-6 md:col-span-1 text-center">
                    <a href="{{route('register')}}">
                        <x-jet-button class="mx-1 rounded-full">Daftar Sekarang</x-jet-button>
                    </a>
