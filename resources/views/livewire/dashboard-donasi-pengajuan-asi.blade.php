...
@endif
                    ...
                    <div class="sm:flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             class="p-2 h-10 w-10 inline-block sm:block bg-orangesa rounded-full text-white"
                             viewBox="0 0 20 20"
                             fill="currentColor">
                    ...
                    <div class="sm:flex-1 min-w-0">
                        <button wire:click="setPage('request_asi')" class="text-left focus:outline-none">
...
@endif relative rounded-lg text-center lg:text-left border border-gray-300 bg-white px-2 lg:px-6 py-5 shadow-sm block sm:flex items-center sm:space-x-3 hover:border-gray-400 focus-within:ring-2 focus-within:ring-offset-2 focus-within:">
                    ...
                    <div class="lg:flex-1 lg:min-w-0 inline-block">
                        <button wire:click="setPage('on_progress')"
                                class=" text-center md:text-left focus:outline-none">
                            <span class="absolute inset-0" aria-hidden="true"></span>
                            <p class="text-sm font-bold text-gray-900">
                                Sedang Berlangsung
                            </p>
...
@endif
                    ...
                    <div class="sm:flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             class="inline-block  sm:block p-2 h-10 w-10 inline-block sm:block bg-orangesa rounded-full text-white"
                             viewBox="0 0 20 20"
                             fill="currentColor">
                            <path fill-rule="evenodd"
                                  d="M3 3a1 1 0 011-1h12a1 1 0 011 1v3a1 1 0 01-.293.707L12 11.414V15a1 1 0 01-.293.707l-2 2A1 1 0 018 17v-5.586L3.293 6.707A1 1 0 013 6V3z"
                    ...
                    <div class="sm:flex-1 sm:min-w-0">
                            <button wire:click="setPage('histori_asi')" class="text-center sm:text-left focus:outline-none">
                                <span class="absolute inset-0" aria-hidden="true"></span>
                                <p class="text-sm font-bold text-gray-900">
                                    Histori ASI
                                </p>
                                    ...
                                    @foreach($DataPermintaanAsi as $DataPermintaan)
                                        @if($DataPermintaan->pivot->progress == 0)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div
                                                        class="text-sm text-gray-900">  {{$DataPermintaan->pivot->quantity_request}}
                                                        Botol
                                                    </div>
                                                    <div class="text-sm text-gray-500">
                    ...
                    @foreach($DataPermintaanAsi as $DataPermintaan)
                        @if($DataPermintaan->pivot->progress == 0)
                                ...
                                <div class="w-full flex items-center justify-between p-6 space-x-6">
                                    <div class="flex-1 truncate">
                                        ...
                                        <p class="mt-1 text-gray-900 text-sm truncate"><span
                                                class="font-bold">{{ $DataPermintaan->pivot->quantity_request }}</span>
                                            Botol (<span
                                                class="font-bold">
                            {{$DataPermintaan->liter_per_pack}} </span>Liter/Botol
                                        ...
                                        <h6 class="mt-2 text-gray-500 text-sm font-medium truncate">Tanggal
                                            Pemesanan: {{date('d M Y',strtotime($DataPermintaan->pivot->created_at))}}</h6>
                    ...
                    <div class="flex-1 truncate">
                        <div class="flex items-center space-x-3">
                            ...
                            @if($DataPermintaan->pivot->progress == 2)
                                <span
                                    class="flex-shrink-0 inline-block px-2 py-0.5 text-white text-xs font-medium bg-orangesa rounded-full">Berhasil</span>
                            @else
                                <span
                                    class="flex-shrink-0 inline-block px-2 py-0.5 text-white text-xs font-medium bg-orangesa rounded-full">Gagal</span>
                            @endif
                        </div>
                        <p class="mt-1 text-gray-500 text-sm truncate">{{$DataPermintaan->city}}</p>
                        ...
                        @if($DataPermintaan->pivot->progress == 2)
                            <h6 class="mt-2 text-gray-500 text-sm font-medium truncate">Tanggal
                                Diterima: {{date('d M Y',strtotime($DataPermintaan->pivot->updated_at))}}</h6>
