            ...
            <div class="content-center grid  lg:grid-cols-1 grid-cols-1 gap-4 sm:grid-cols-2">
                <div
                    ...
                    <div class="flex-1 min-w-0">
                        <a href="/dashboard/donasi" class="focus:outline-none">
                    ...
                    <div class="flex items-center">
                        <div class="flex-shrink-0 h-10 w-10">
                            <img class="h-10 w-10 rounded-full"
                                 src="{{$dataPesananResipien->profile_photo_url}}">
                        </div>
                        <div class="ml-4">
                            <div class="text-sm font-medium text-gray-900">
                            {{$dataPesananResipien->name}}
                            </div>
                            <div class="text-sm text-gray-500">
                                <!--  -->
                                Tanggal Permintaan : {{date('d M Y',strtotime($dataPesananResipien->pivot->created_at))}}
                            </div>
                        </div>
                    </div>
                </div>
                <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
                    <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-3">
                        <div class="sm:col-span-1">
                            ...
                            @if($dataPesananResipien->pivot->courir_request == 1)
                                                    <span
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{$dataPesananResipien->pivot->quantity_request}} Botol
                            </dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-sm font-medium text-gray-500">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{$dataPesananResipien->asiResipiens[0]->liter_per_pack}}
                            </dd>
                        </div>
                        <div class="sm:col-span-3 q">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{$dataPesananResipien->asiResipiens[0]->description}}
                            </dd>
                        </div>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{$dataPesananResipien->pivot->detail_address_resipien}}
                            </dd>
                        </div>
                        <form method="POST" action="{{ route('proses-request-pendonor') }}">
                            @csrf
